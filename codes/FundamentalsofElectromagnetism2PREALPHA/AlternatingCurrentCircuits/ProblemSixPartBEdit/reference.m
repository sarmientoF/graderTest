...
fprintf('For low frequencies, Vout1 is : \n');
pretty(Vout1_low)
fprintf('For low frequencies, Vout2 is : \n');
pretty(Vout1_low)
...
fprintf('For high frequencies, Vout1 is : %.3f \n', Vout1_high);
fprintf('For high frequencies, Vout2 is : %.3f \n', Vout2_high);